...
public class ClubMatchTM {
    ...
    public ClubMatchTM(int matchNumber, String club1, String club2, int scoreClub1, int scoreClub2, Date date) {
    ...
    public ClubMatchTM(String club1, String club2, int scoreClub1, int scoreClub2) {
        this.club1 = club1;
        this.club2 = club2;
        this.scoreClub1 = scoreClub1;
        this.scoreClub2 = scoreClub2;
